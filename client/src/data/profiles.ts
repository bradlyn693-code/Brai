...
const sourcePhotos = [
  ...
  "https://images.unsplash.com/photo-1531123414780-f74242c2b052?w=800&h=1000&fit=crop&crop=face",
...
const details = [
  ...
  ["Liya", 23, "Addis Ababa", "Illustrator", "Colour, coffee, and conversations that wander somewhere beautiful.", ["Illustration", "Coffee", "Museums", "Dancing"]],
  ["Chidera", 24, "Abuja", "UX researcher", "Give me a good playlist, a plate of jollof, and a reason to stay out longer.", ["Tech", "Jollof", "Podcasts", "Running"]],
  ["Iman", 22, "Dar es Salaam", "Marine biologist", "Ocean air, curious questions, and finding magic in the details.", ["Ocean life", "Cooking", "Photography", "Dancing"]],
  ["Sasha", 25, "Kampala", "Community lead", "Big on kindness, long lunches, and making people feel at home.", ["Community", "Brunch", "Gardening", "Travel"]],
  ["Zola", 23, "Cape Town", "Brand strategist", "A good view, a thoughtful playlist, and a reason to laugh every day.", ["Branding", "Hiking", "Photography", "Wine tasting"]],
  ["Aaliyah", 22, "Nairobi", "Marketing specialist", "Always planning the next adventure and the best meal after it.", ["Travel", "Wellness", "Books", "Cooking"]],
] as const;
