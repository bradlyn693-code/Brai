...
function Login() {
  ...
  const submit = (event: React.FormEvent) => {
    ...
    const nextUser = existing?.email === normalizedEmail ? { ...existing, email: normalizedEmail } : { email: normalizedEmail, name: normalizedEmail.split("@")[0] || "Lovely human", coins: 0, premium: false };
