...
function Dashboard() {
  ...
  const currentUser = getUser(); const myGender = (currentUser?.gender || currentUser?.sex || "male").toLowerCase(); const oppositeGender = myGender === "male" ? "female" : "male";
